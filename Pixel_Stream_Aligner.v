// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\EdgeDetectionAndOverlayHDL\Pixel_Stream_Aligner.v
...
// Source Path: EdgeDetectionAndOverlayHDL/Pixel-Stream HDL Model/Pixel Stream Aligner
// Hierarchy Level: 1
// 
...
module Pixel_Stream_Aligner
  ...
  reg [14:0] line0Starts;  // ufix15
  reg [14:0] line1Starts;  // ufix15
  reg [14:0] line2Starts;  // ufix15
  reg [14:0] line3Starts;  // ufix15
  reg [14:0] line4Starts;  // ufix15
  reg [14:0] line5Starts;  // ufix15
  reg [14:0] line6Starts;  // ufix15
  reg [14:0] line7Starts;  // ufix15
  reg [14:0] line8Starts;  // ufix15
  reg [14:0] line9Starts;  // ufix15
  wire [14:0] linerddata;  // ufix15
  reg [14:0] frameStart;  // ufix15
  wire [14:0] RAMrdloadval;  // ufix15
  wire refEarlyInFrame;  // ufix1
  wire refEarlyInLine;  // ufix1
  wire [14:0] constone;  // ufix15
  reg [14:0] RAMrdaddr;  // ufix15
  wire [14:0] RAMrdnextaddr;  // ufix15
  wire relop_relop1;
  wire notholdaddr;  // ufix1
  wire RAMrden;  // ufix1
  wire [7:0] RAMrddata;  // uint8
  wire [7:0] pixelOutReg;  // uint8
  reg [7:0] pixelOut;  // uint8
  ...
  always @(posedge clk or posedge reset)
    begin : wraddrcounter_process
      if (reset == 1'b1) begin
        RAMwraddr <= 15'b000000000000000;
      end
      else begin
        if (enb && RAMwren) begin
          RAMwraddr <= RAMwraddr + 15'b000000000000001;
        end
      end
    end
  ...
  always @(posedge clk or posedge reset)
    begin : lsreg_process
      if (reset == 1'b1) begin
        line0Starts <= 15'b000000000000000;
      end
      else begin
        if (enb && line0StartsEn) begin
  ...
  always @(posedge clk or posedge reset)
    begin : lsreg_1_process
      if (reset == 1'b1) begin
        line1Starts <= 15'b000000000000000;
      end
      else begin
        if (enb && line1StartsEn) begin
  ...
  always @(posedge clk or posedge reset)
    begin : lsreg_2_process
      if (reset == 1'b1) begin
        line2Starts <= 15'b000000000000000;
      end
      else begin
        if (enb && line2StartsEn) begin
  ...
  always @(posedge clk or posedge reset)
    begin : lsreg_3_process
      if (reset == 1'b1) begin
        line3Starts <= 15'b000000000000000;
      end
      else begin
        if (enb && line3StartsEn) begin
  ...
  always @(posedge clk or posedge reset)
    begin : lsreg_4_process
      if (reset == 1'b1) begin
        line4Starts <= 15'b000000000000000;
      end
      else begin
        if (enb && line4StartsEn) begin
  ...
  always @(posedge clk or posedge reset)
    begin : lsreg_5_process
      if (reset == 1'b1) begin
        line5Starts <= 15'b000000000000000;
      end
      else begin
        if (enb && line5StartsEn) begin
  ...
  always @(posedge clk or posedge reset)
    begin : lsreg_6_process
      if (reset == 1'b1) begin
        line6Starts <= 15'b000000000000000;
      end
      else begin
        if (enb && line6StartsEn) begin
  ...
  always @(posedge clk or posedge reset)
    begin : lsreg_7_process
      if (reset == 1'b1) begin
        line7Starts <= 15'b000000000000000;
      end
      else begin
        if (enb && line7StartsEn) begin
  ...
  always @(posedge clk or posedge reset)
    begin : lsreg_8_process
      if (reset == 1'b1) begin
        line8Starts <= 15'b000000000000000;
      end
      else begin
        if (enb && line8StartsEn) begin
  ...
  always @(posedge clk or posedge reset)
    begin : lsreg_9_process
      if (reset == 1'b1) begin
        line9Starts <= 15'b000000000000000;
      end
      else begin
        if (enb && line9StartsEn) begin
  ...
  always @(posedge clk or posedge reset)
    begin : fsreg_process
      if (reset == 1'b1) begin
        frameStart <= 15'b000000000000000;
      end
      else begin
        if (enb && pixelnewFrame) begin
  ...
  assign constone = 15'b000000000000001;
      ...
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          if (RAMrdload == 1'b1) begin
            ...
            RAMrdaddr <= RAMrdaddr + 15'b000000000000001;
          end
        end
      end
    end
  ...
  SimpleDualPortRAM_generic #(.AddrWidth(15),
                              .DataWidth(8)
                              )
